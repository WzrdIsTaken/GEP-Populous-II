...
private:
    ...
    UiManager* m_canvas = NULL; //UI Manager
    ...
    // ECS Magic
    std::shared_ptr<Engine::PhysicsSystem> physics_system;
    std::shared_ptr<Engine::RenderSystem> render_system;
    std::shared_ptr<Engine::CameraSystem> camera_system;
};
